...
async function __wbg_init(module_or_path) {
  ...
  if (typeof module_or_path === "undefined") {
    module_or_path = new URL("lru_sim_bg.wasm", import.meta.url);
  }
...
var lru_sim_default = __wbg_init;
...
lru_sim_default().then(() => {
  ...
  const tracesSelect = document.querySelector("#traces-select");
